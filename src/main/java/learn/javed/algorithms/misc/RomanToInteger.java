...
public class RomanToInteger {
	...
	public static void main(String[] args) {
		...
		System.out.println(new RomanToInteger().convert("VIII"));
		System.out.println(new RomanToInteger().convert("MCMXCIV"));
		System.out.println(new RomanToInteger().convert("XIX"));
		System.out.println(new RomanToInteger().convert("MCMLXXXIII"));
	}
